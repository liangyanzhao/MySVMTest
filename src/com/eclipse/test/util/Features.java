...
public class Features{
	...
	/**
	 * 热力学函数  熵
	 * java.lang.Math.log(double a) 返回自然对数（以e为底）的一个double值。
	 * 特殊情况：如果参数是NaN或小于零，那么结果是NaN.如果参数是正无穷大，那么结果是正无穷大。如果参数是正零或负零，那么结果是负无穷大。
